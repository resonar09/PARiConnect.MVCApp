...
{
    public class SEARSPT : IDynamicFormModel
    {
        public List<Input> Inputs { get; set; }
        public Settings Settings { get; set; }
        private IGroupData _groupData;

        public SEARSPT(IGroupData groupData)
        {
            _groupData = groupData;
            Settings = new Settings();
            Settings.Layout = LayoutType.TwoColumn;
            Settings.Container = ContainerType.Modal;
            Settings.ContainerName = "searsPTModal";
            Settings.Columns = 2;
            Settings.Title = "SEARS Demographics";
            ...
            Inputs = new List<Input>
            {
                ...
                new Input {
                    ...
                    Label = "Child's Grade:",
                    Type = InputType.select.ToString(),
                    Options = Utility.GetSEARSPTGradeOptions(),
                    Placeholder ="",
                    Class = "",
                    Column = 2,
                    BatchValidation = true,
                ...
                new Input {
                    ...
                    Label = "Setting where rater observes or interacts with the child:",
                    Type = InputType.text.ToString(),
                    Placeholder ="",
                    Class = "",
                    Column = 2,
