...
{
    public class SEARSA : IDynamicFormModel
    {
        public List<Input> Inputs { get; set; }
        public Settings Settings { get; set; }
        private IGroupData _groupData;

        public SEARSA(IGroupData groupData)
        {
            _groupData = groupData;
            Settings = new Settings();
            Settings.Layout = LayoutType.TwoColumn;
            Settings.Container = ContainerType.Modal;
            Settings.ContainerName = "searsAModal";
            Settings.Columns = 2;
            Settings.Title = "SEARS A Form Demographics";
            ...
            Inputs = new List<Input>
            {
                ...
                new Input {
                    ...
                    Label = "Grade:",
                    Type = InputType.select.ToString(),
                    Options = Utility.GetSEARSAGradeOptions(),
                    Placeholder ="",
                    Class = "",
                    Column = 2,
                    BatchValidation = true,
