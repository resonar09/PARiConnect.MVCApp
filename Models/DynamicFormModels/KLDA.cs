...
{
    public class KLDA : IDynamicFormModel
    {
        public List<Input> Inputs { get; set; }
        public Settings Settings { get; set; }
        private IGroupData _groupData;
        
        public KLDA(IGroupData groupData) 
        {
             _groupData = groupData;
            Settings = new Settings();
            Settings.Layout = LayoutType.TwoColumn;
            Settings.Container = ContainerType.Modal;
            Settings.ContainerName = "kldaModal";
            Settings.Columns = 2;
            Settings.Title = "KLDA Demographics";
            ...
            Inputs = new List<Input>
            {
                ...
                new Input {
                    ...
                    Label = "School type:",
                    Type = InputType.radioVertical.ToString(),
                    Options = Utility.GetSchoolOptions(),
                    Placeholder ="",
                    Class = "",
                    Column = 2,
                },
                new Input {
                    Id = InputIDType.otherSchool.ToString(),
                ...
                new Input {
                    Id = InputIDType.schoolYear.ToString(),
                    Label = "Year in school:",
                    Type = InputType.radioVertical.ToString(),
                    Options = Utility.GetSchoolYearOptions(),
                    Placeholder ="",
                    Class = "",
                    Column = 2,
                },
                new Input {
                    Id = InputIDType.otherSchoolYear.ToString(),
                    Label = "If Other, please specify",
                    Type = InputType.text.ToString(),
                    Placeholder = "",
                    Class = "",
