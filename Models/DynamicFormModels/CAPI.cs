...
{
    public class CAPI : IDynamicFormModel
    {
        public List<Input> Inputs { get; set; }
        public Settings Settings { get; set; }
        private IGroupData _groupData;
        
        public CAPI(IGroupData groupData) 
        {
             _groupData = groupData;
            Settings = new Settings();
            Settings.Layout = LayoutType.TwoColumn;
            Settings.Container = ContainerType.Modal;
            Settings.ContainerName = "capiModal";
            Settings.Columns = 2;
            Settings.Title = "CAPI Demographics";
            ...
            Inputs = new List<Input>
            {
                ...
                new Input {
                    ...
                    Options = Utility.GetEthnicity2Options(),
                    Placeholder ="",
                    Class = "",
                    Column = 2
                },
                new Input {
                    Id = InputIDType.otherEthnicity.ToString(),
                    Label = "Other Race:",
                    Type = InputType.text.ToString(),
                    Placeholder ="",
                    Class = "",
                ...
                new Input {
                    Id = InputIDType.numChildren.ToString(),
                    Label = "Number of children in home:",
                    Type = InputType.text.ToString(),
                    Placeholder ="",
                    Class = "",
                    Column = 2,
                ...
                new Input {
                    Id = InputIDType.highestGrade.ToString(),
