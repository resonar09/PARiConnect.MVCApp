...
{
    public class PAIA : IDynamicFormModel
    {
        public List<Input> Inputs { get; set; }
        public Settings Settings { get; set; }
        private IGroupData _groupData;

        public PAIA(IGroupData groupData)
        {
            _groupData = groupData;
            Settings = new Settings();
            Settings.Layout = LayoutType.TwoColumn;
            Settings.Container = ContainerType.Modal;
            Settings.ContainerName = "paiaModal";
            Settings.Columns = 2;
            Settings.Title = "PAI-A Demographics";
            ...
            Inputs = new List<Input>
            {
                ...
                new Input {
                    ...
                    Options = Utility.GetGrade4Options(),
                    Placeholder ="",
                    Class = "",
                    Column = 2
                },
                ...
                new Input {
                    Id = InputIDType.diagnosis.ToString(),
