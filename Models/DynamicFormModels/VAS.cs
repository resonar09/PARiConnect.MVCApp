...
{
    public class VAS : IDynamicFormModel
    {
        public List<Input> Inputs { get; set; }
        public Settings Settings { get; set; }
        private IGroupData _groupData;

        public VAS(IGroupData groupData)
        {
            _groupData = groupData;
            Settings = new Settings();
            Settings.Layout = LayoutType.TwoColumn;
            Settings.Container = ContainerType.Modal;
            Settings.ContainerName = "vasModal";
            Settings.Columns = 2;
            Settings.Title = "VAS Demographics";
            ...
            Inputs = new List<Input>
            {
                ...
                new Input {
                    ...
                    Label = "Grade:",
                    Type = InputType.select.ToString(),
                    Options = Utility.GetGrade7Options(),
                    Placeholder ="",
                    Class = "",
                    Column = 1
                },
                ...
                new Input {
                    Id = InputIDType.referralReason.ToString(),
