...
{
    public class BRIEFA_SELF : IDynamicFormModel
    {
        public List<Input> Inputs { get; set; }
        public Settings Settings { get; set; }
        private IGroupData _groupData;
        
        public BRIEFA_SELF(IGroupData groupData) 
        {
            ...
            Settings.ContainerName = "briefASelfModal";
            Settings.Title = "BRIEF-A Self Demographics";
            ...
            Inputs = new List<Input>
            {
                ...
                new Input {
                    Id = InputIDType.education.ToString(),
                    Label = "Level of Education:",
                    Type = InputType.select.ToString(),
                    Options = Utility.GetEducationOptions(),
                    Placeholder ="",
                    Class = "",
                    Column = 2
                },
                new Input {
                    ...
                    Type = InputType.select.ToString(),
                    Options = Utility.GetEducationYearsOptions(),
                    Placeholder ="",
                    Class = "",
                    Column = 2
                },
