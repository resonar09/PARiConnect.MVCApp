...
{
    public class FAM : IDynamicFormModel
    {
        public List<Input> Inputs { get; set; }
        public Settings Settings { get; set; }
        private IGroupData _groupData;
        
        public FAM(IGroupData groupData) 
        {
             _groupData = groupData;
            Settings = new Settings();
            Settings.Layout = LayoutType.TwoColumn;
            Settings.Container = ContainerType.Modal;
            Settings.ContainerName = "famModal";
            Settings.Columns = 2;
            Settings.Title = "FAM Demographics";
            ...
            Inputs = new List<Input>
            {
                ...
                new Input {
                    ...
                    Placeholder ="Please enter the grade used for FAM administration. This grade will be used to look up the normative scores associated with the raw scores entered on the next screen.",
                    Class = "",
                    Column = 2,
                },
                new Input {
